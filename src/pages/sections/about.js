...
import { Chip, Card, CardHeader, CardBody, ScrollShadow } from "@nextui-org/react";
...
export default function About() {
    ...
    return (
        <>
            <div className="flex flex-col justify-center items-center gap-6" id="about">
                <Chip color="secondary">About Us</Chip>
                <div className="flex flex-col">
                    <div className="flex">
                        <section className="bubbledivider min-w-full h-16 animate-scroll shrink-0"></section>
                        <section className="bubbledivider min-w-full h-16 animate-scroll shrink-0"></section>
                    </div>
                    <div className="flex flex-col md:flex-row gap-6 md:p-6 md:px-24 justify-stretch items-center bg-secondary shadow-lg">
                    ...
                    <div className="flex">
                        <section className="bubbledividerinverted min-w-full h-16 animate-scroll shrink-0"></section>
                        <section className="bubbledividerinverted min-w-full h-16 animate-scroll shrink-0"></section>
                    </div>
                </div>
            </div>
